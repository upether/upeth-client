...
import { Dropdown, DropdownItem, Nav, StyledSpan, Menu, DropdownButton } from './styles/chartNav.styles';
        ...
        <div style={{ display: "flex", justifyContent: "flex-start" }}>
            ...
            <Menu className="menu">
                <DropdownButton onClick={isOpenHandler}>
                    <div style={{ heigth: "38px", alignContent: "center" }}>{`${period?.periodicityNumber}${periodicityTable[period?.periodicity]}`}</div>
                </DropdownButton>
