...
export const useMiniChartInfoOfMinutes = ({ symbolID: market = "KRW-BTC", count = 150, refetchInterval = 10000 }) => {
    return useQuery(['useMinChartInfo', "minutes", market], () => {
...
export const useChartInfoOfMinutes = ({ symbolID: market = "KRW-BTC", value = 1, count = 150, refetchInterval = 10000 }) => {
    return useQuery(['useChartInfo', "minutes", market], () => {
        return fetch(`https://api.upbit.com/v1/candles/minutes/${value}?market=${market}&count=${count}`)
            .then(
                async (res) => {
                    const result = await res.json();
...
export const useChartInfoOfDaysWeeksMonths = ({ type = `days`, symbolID: market = "KRW-BTC", count = 200, refetchInterval = 10000 }) => {
